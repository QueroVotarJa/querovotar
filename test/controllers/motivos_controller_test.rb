...
class MotivosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create motivo" do
    assert_difference('Motivo.count') do
      post motivos_url, params: { motivo: { estado: @motivo.estado, nome: @motivo.nome, porque: @motivo.porque } }
    end
  ...
  test "should update motivo" do
    patch motivo_url(@motivo), params: { motivo: { estado: @motivo.estado, nome: @motivo.nome, porque: @motivo.porque } }
